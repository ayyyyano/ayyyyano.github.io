...
;(function() {
  var P = (typeof globalThis !== 'undefined' ? globalThis : window).PIXI;
  if (!P) { window.__live2dDiag = "PIXI undefined after cubism4"; return; }
  var l2d = P.live2d;
  if (!l2d) { window.__live2dDiag = "PIXI.live2d undefined; PIXI keys=" + Object.keys(P).slice(0,15).join(','); return; }
  var l2dKeys = Object.keys(l2d).join(',');
  var hasUtils = !!P.utils;
  var hasApp = !!P.Application;
  var hasContainer = !!P.Container;
  var hasObservablePoint = !!P.ObservablePoint;
  window.__live2dDiag = "live2d keys=" + l2dKeys + "; utils=" + hasUtils + "; App=" + hasApp + "; Container=" + hasContainer + "; ObsPoint=" + hasObservablePoint;
})();
